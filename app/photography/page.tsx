  ...
  return (
        <main className="max-w-6xl mx-auto px-6 pt-24 pb-12 relative z-10">
          ...
          <div className="text-center mb-16">
            <a href="/" className="inline-flex items-center text-[#D4AF37] hover:text-[#FAF7F0] transition-colors mb-4">
              ← Back to Home
            </a>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* New York Card */}
            <a href="/photography/new-york" className="block no-underline">
              <div className="bg-black/20 backdrop-blur-sm rounded-lg overflow-hidden border border-[#D4AF37]/20">
                <div className="aspect-video">
                  <img src="/new-york/camera.jpeg" alt="New York City" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
