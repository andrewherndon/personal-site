  ...
  return (
    <main className="max-w-6xl mx-auto px-6 pt-24 pb-12 relative z-10">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/pictures/singapore" className="block no-underline">
          <div className="bg-black/20 backdrop-blur-sm rounded-lg overflow-hidden border border-[#D4AF37]/20">
            <div className="aspect-video relative">
              <Image src="/singapore/palace.jpg" alt="Royal Palace" fill className="object-cover" />
            </div>
            <div className="p-4">
              <h3 className="text-lg font-bold text-[#D4AF37] mb-1">Singapore</h3>
              ...
              <div className="text-xs text-[#FAF7F0]/60">7 photographs</div>
            </div>
          </div>
        </Link>
        {/* New York Card */}
        <Link href="/pictures/new-york" className="block no-underline">
          <div className="bg-black/20 backdrop-blur-sm rounded-lg overflow-hidden border border-[#D4AF37]/20">
            <div className="aspect-video relative">
