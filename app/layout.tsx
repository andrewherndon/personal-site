...
export const metadata: Metadata = {
  title: "Andrew Herndon - Software Engineer",
  description: "Computer Science student at Georgia Tech specializing in AI, full-stack development, and machine learning systems.",
};
