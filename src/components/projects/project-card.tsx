        ...
        <CardContent className="bg-[var(--card-bg)] text-white pt-6 flex-grow">
          ...
          <div className="mb-5">
            <h4 className="font-semibold mb-3 text-gold">
              <T id="components.projects.project_card.highlights_title">Highlights:</T>
            </h4>
            ...
            {links.github && (
              ...
              >
                <Button variant="outline" className="rounded-lg">
                  ...
                  <T id="components.projects.project_card.github_button">GitHub</T>
                </Button>
              </Link>
            )}
            {links.live && (
              ...
              >
                <Button className="rounded-lg">
                  ...
                  <T id="components.projects.project_card.live_button">Live Site</T>
                </Button>
              </Link>
            )}
          </div>
